...
all: create_dir pre_process_data pre_process_query gen_cluster convert gen_title_len gen_bitmap phase1_search phase2_index phase2_index_search phase2_read_bitmap phase2_search single_query_search batch_query_search
...
phase2_search:
	$(CC) $(CFLAGS) $(addprefix $(SOURCE)/data_structures/, Vid_Occurence.cpp Fid_Occurence.cpp ScoreResult.cpp) $(addprefix $(SOURCE)/phase2/search_step/, Phase2_Searcher.cpp Phase2_SearcherDriver.cpp) $(CFLAGS) -o $(TARGET)/phase2_search
