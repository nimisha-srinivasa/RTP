...
phase2_index_search:
	$(CC) $(CFLAGS) -o $(TARGET)/phase2_index_search $(addprefix $(SOURCE)/utils/, Stemmer.cpp Serializer.cpp) $(addprefix $(SOURCE)/phase2/search_step/, Phase2_IndexSearcher.cpp Phase2_IndexSearcherDriver.cpp) $(OPENSSL_FLAGS)
...
phase2_cluster_search:
	$(CC) $(CFLAGS) $(addprefix $(SOURCE)/data_structures/, Vid_Occurence.cpp Fid_Occurence.cpp ScoreResult.cpp) $(addprefix $(SOURCE)/phase2/search_step/, Phase2_ClusterSearcher.cpp Phase2_ClusterSearchDriver.cpp) $(CFLAGS) -o $(TARGET)/phase2_cluster_search

single_query_search:
	$(CC) $(CFLAGS) $(addprefix $(SOURCE)/data_structures/, ScoreResult.cpp) $(addprefix $(SOURCE)/phase1/search_step/, Phase1_Searcher.cpp) $(addprefix $(SOURCE)/phase2/search_step/, Phase2_SearchRunner.cpp) $(addprefix $(SOURCE)/search_scripts/, SingleQuerySearcher.cpp SingleQuerySearchDriver.cpp) -o $(TARGET)/single_query_search $(PARSER_FLAG)

batch_query_search:
	$(CC) $(CFLAGS) $(addprefix $(SOURCE)/data_structures/, ScoreResult.cpp) $(addprefix $(SOURCE)/phase1/search_step/, Phase1_Searcher.cpp) $(addprefix $(SOURCE)/phase2/search_step/, Phase2_SearchRunner.cpp) $(addprefix $(SOURCE)/search_scripts/, SingleQuerySearcher.cpp BatchQuerySearchDriver.cpp) -o $(TARGET)/batch_query_search $(PARSER_FLAG)
