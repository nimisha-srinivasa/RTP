...
all : create_dir pre_process_data pre_process_query gen_cluster convert gen_title_len gen_bitmap phase1_search phase2_index phase2_index_search phase2_read_bitmap phase2_cluster_search single_query_search batch_query_search
